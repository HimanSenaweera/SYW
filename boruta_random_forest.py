...
# INSTALLATION:
# pip install Boruta
# NOTE: Package name is "Boruta" (capital B) on PyPI
# but you import it as "from boruta import BorutaPy"
...
if "boruta_applied_ranking" not in boruta_merge.columns:
    boruta_merge["boruta_applied_ranking"] = 10**9
if "boruta_approved_ranking" not in boruta_merge.columns:
    boruta_merge["boruta_approved_ranking"] = 10**9
    
boruta_merge["boruta_applied_ranking"] = boruta_merge["boruta_applied_ranking"].fillna(10**9)
boruta_merge["boruta_approved_ranking"] = boruta_merge["boruta_approved_ranking"].fillna(10**9)
